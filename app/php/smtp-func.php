...
function smtpmail($mail_to, $subject, $message, $headers='') {
        ...
        //Настройки почты
        $config['smtp_username'] = 'info@палехагромаш.рф';  //Смените на имя своего почтового ящика из ISPManager.
        $config['smtp_password'] = '123qwert';  //Измените пароль.
        $config['smtp_from']     = 'Заявка с сайта ПалехАгромаш'; //Ваше имя - или имя Вашего сайта. Будет показывать при прочтении в поле "От кого".
